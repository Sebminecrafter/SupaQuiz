...
Do While quit=0
	Randomize
	ttlqst = ttlqst+1
	rand1 = (Int((100-1+1)*Rnd+1))
	rand2 = (Int((100-1+1)*Rnd+1))
	answer = Int(rand1+rand2)
	userinput=inputbox("What is "&rand1&"+"&rand2&"? OR Type 'quit' to exit the game.", "Addition Quiz", "Type answer here (number only)...")
...
MsgBox "Thanks for playing!", 0+64
